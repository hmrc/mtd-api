...
package api.models.errors.v1

import api.models.errors.MtdError

// Rule Errors
object RuleTaxYearNotSupportedError
    extends MtdError(code = "RULE_TAX_YEAR_NOT_SUPPORTED", message = "Tax year not supported, because it precedes the earliest allowable tax year")
